...
(function($) {
    ...
    /* 03: Off Canvas
    ==============================================*/
    var $canvas = $('.arviandt--off-canvas');
    var $canol = $('.nav-ol');
    ...
    /* 04: Navbar
    ==============================================*/
    var $menu = $('.arviandt--nav-menu');
    var $canvasMenu = $('.arviandt--off-canvas-menu');
    ...
    $('.arviandt--nav-menu ul li.menu-item-has-children .submenu-button').prepend('<i class="fa fa-angle-down"></i>');
    ...
    $('.arviandt--off-canvas-menu ul li.menu-item-has-children .submenu-button').prepend('<i class="fa fa-angle-down"></i>');
    $('.arviandt--off-canvas-menu ul li.menu-item-has-children .sub-menu').hide();
    
    $('.arviandt--off-canvas-menu ul li.menu-item-has-children .submenu-button').on('click', function(){
    ...
    $(".arviandt--faq-items .arviandt--faq-item .target-area h3").on("click", function(t) {
        $(this).parents(".arviandt--faq-item").children(".collapse").hasClass("show") && (t.stopPropagation(), t.preventDefault());
    });
    ...
    /* 11: Ajax Contact Form
    ==============================================*/
    $('.arviandt--contact-form').on('submit', 'form', function(e) {
        e.preventDefault();
        ...
        $.post($el.attr('action'), $el.serialize(), function(res){
            res = $.parseJSON( res );
            $el.parent('.arviandt--contact-form').find('.form-response').html('<span>' + res[1] + '</span>');
        });
    });
